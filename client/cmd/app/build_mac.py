...
def main():
    ...
    dist_starfire = os.path.join("dist", "starfire")
    if os.path.exists("starfire"):
        shutil.copy2("starfire", dist_starfire)
        print("✓ Copied starfire.exe to dist folder")
    else:
        print("⚠ starfire.exe not found in source directory")
    
    # Step 4: Check output
    exe_path = os.path.join("dist", "StarFire_MaaS")
    if os.path.exists(exe_path):
        ...
        starfire_dist = os.path.join("dist", "starfire")
